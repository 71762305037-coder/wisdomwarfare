...
// Initialize crossword routes and socket handlers
// Reuse existing upload multer configuration for CSV files
...
crosswordSocketModule.initializeCrosswordSocketHandlers(io, pool, {
  ...
  crosswordLocks: crosswordRoutesModule.crosswordLocks,
  crosswordWaitingPlayers: crosswordRoutesModule.crosswordWaitingPlayers,
  getWaitingPlayerMap: crosswordRoutesModule.getWaitingPlayerMap,
  emitWaitingLeaderboard: crosswordRoutesModule.emitWaitingLeaderboard,
  finalizeCrosswordGame: crosswordRoutesModule.finalizeCrosswordGame,
  emitCrosswordLeaderboard: crosswordRoutesModule.emitCrosswordLeaderboard,
  getSolvedWordIdsForUser: crosswordRoutesModule.getSolvedWordIdsForUser,
  getOrCreateSolvedUserSet: crosswordRoutesModule.getOrCreateSolvedUserSet,
  ensureCrosswordLeaderboardEntry: crosswordRoutesModule.ensureCrosswordLeaderboardEntry,
  emitCrosswordGrid: crosswordRoutesModule.emitCrosswordGrid,
  getRemainingCrosswordTimeMs: crosswordRoutesModule.getRemainingCrosswordTimeMs,
  hasPlayableCrosswordSession: crosswordRoutesModule.hasPlayableCrosswordSession,
  upsertCrosswordScore: crosswordRoutesModule.upsertCrosswordScore,
});
